export const themes = {
  light: {
    ...
    card: {
      ...
      boxShadow:
        "0px 50px 100px rgba(34, 79, 169, 0.3), inset 0 0 0 0.5px rgba(255, 255, 255, .6)",
    ...
    modal: {
      backgroundColor: "rgba(255,255,255,0.6)",
      boxShadow:
        "0px 50px 100px rgba(34, 79, 169, 0.3), inset 0 0 0 0.5px rgba(255, 255, 255, 1)",
      backgroundColorFull: "rgba(255,255,255,1)",
    },
  },
  dark: {
    ...
    card: {
      ...
      boxShadow:
        "0px 30px 60px rgba(0, 0, 0, 0.25), inset 0 0 0 0.5px rgba(255, 255, 255, .2)",
    ...
    modal: {
      ...
      boxShadow:
        "0px 50px 100px rgba(0, 0, 0, 0.25), inset 0 0 0 0.5px rgba(255, 255, 255, .3)",
      backgroundColorFull: "rgba(15,14,71,1)",
    },
  },
}
